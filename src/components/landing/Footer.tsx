...
export function Footer() {
  return (
    <footer className="bg-background text-foreground transition-colors duration-500 border-t border-border">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 md:gap-10 py-12 md:py-16">
          ...
          <div className="col-span-2">
            ...
            <div className="flex flex-wrap gap-2 items-center">
              {/* Google Play */}
              <a href="#" className="inline-flex items-center gap-2 bg-foreground rounded px-3 py-1.5 hover:opacity-90 hover:scale-[1.02] transition-all duration-200">
                ...
                <div className="leading-none">
                  <p className="text-[8px] text-background/60 leading-none uppercase">Get it on</p>
                  <p className="text-sm font-semibold text-background leading-tight -mt-px">Google Play</p>
                </div>
              </a>
              {/* App Store */}
              <a href="#" className="inline-flex items-center gap-2 bg-foreground rounded px-3 py-1.5 hover:opacity-90 hover:scale-[1.02] transition-all duration-200">
                <svg viewBox="0 0 384 512" className="w-5 h-5 shrink-0 text-background" fill="currentColor">
                ...
                <div className="leading-none">
                  <p className="text-[8px] text-background/60 leading-none">Download on the</p>
                  <p className="text-sm font-semibold text-background leading-tight -mt-px">App Store</p>
                </div>
              </a>
            </div>
          </div>
