    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background transition-colors duration-300">
      <nav className="max-w-7xl mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link
            href="/sign-up"
            className="btn-metal-shine inline-flex items-center bg-foreground text-background font-semibold px-5 py-2 rounded-full text-sm hover:bg-foreground/90 transition-colors"
          >
            Get Started Free
          </Link>
        </div>
      ...
      >
        <div className="px-4 py-4 flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-2 pt-2 border-t border-border">
            ...
            <Link
              href="/sign-up"
              className="btn-metal-shine inline-flex items-center justify-center bg-foreground text-background font-semibold px-5 py-2.5 rounded-full text-sm hover:bg-foreground/90 transition-colors"
            >
              Get Started Free
            </Link>
          </div>
