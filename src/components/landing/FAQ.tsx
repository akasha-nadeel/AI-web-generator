          ...
          >
            ...
            <h2 className="text-[clamp(45px,6vw,82px)] font-medium text-foreground leading-[1.05] tracking-tight mb-6">
              ...
              <svg viewBox="0 0 80 80" className="inline-block w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 ml-2 -mt-2 pointer-events-none select-none -rotate-[15deg]" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M34 34C30 26 22 20 20 22" stroke="currentColor" strokeWidth="0.5" opacity="0.3" className="text-background" />
                <path d="M32 35C28 28 22 22 18 24" stroke="currentColor" strokeWidth="0.4" opacity="0.2" className="text-background" />
                ...
                <path d="M35 44C30 50 26 54 24 56" stroke="currentColor" strokeWidth="0.4" opacity="0.2" className="text-background" />
                ...
                <path d="M46 34C50 26 58 20 60 22" stroke="currentColor" strokeWidth="0.5" opacity="0.3" className="text-background" />
                <path d="M48 35C52 28 58 22 62 24" stroke="currentColor" strokeWidth="0.4" opacity="0.2" className="text-background" />
                ...
                <path d="M45 44C50 50 54 54 56 56" stroke="currentColor" strokeWidth="0.4" opacity="0.2" className="text-background" />
                ...
                {/* Body */}
                <ellipse cx="40" cy="40" rx="2.5" ry="10" className="fill-foreground/90" />
                <ellipse cx="40" cy="40" rx="1.5" ry="9" className="fill-foreground/80" />
                {/* Head */}
                <circle cx="40" cy="29" r="3" className="fill-foreground/90" />
                <circle cx="39" cy="28.5" r="0.8" fill="#fff" opacity="0.4" />
                <circle cx="41" cy="28.5" r="0.8" fill="#fff" opacity="0.4" />
                {/* Antennae */}
                <path d="M39 27C35 20 30 14 26 12" stroke="currentColor" strokeWidth="0.8" fill="none" strokeLinecap="round" className="text-foreground/40" />
                <path d="M41 27C45 20 50 14 54 12" stroke="currentColor" strokeWidth="0.8" fill="none" strokeLinecap="round" className="text-foreground/40" />
                <circle cx="26" cy="12" r="1.5" fill="#f59e0b" />
                <circle cx="54" cy="12" r="1.5" fill="#f59e0b" />
                {/* Body segments */}
                <line x1="38" y1="34" x2="42" y2="34" stroke="currentColor" strokeWidth="0.4" className="text-foreground/30" />
                <line x1="38" y1="37" x2="42" y2="37" stroke="currentColor" strokeWidth="0.4" className="text-foreground/30" />
                <line x1="38" y1="40" x2="42" y2="40" stroke="currentColor" strokeWidth="0.4" className="text-foreground/30" />
                <line x1="38" y1="43" x2="42" y2="43" stroke="currentColor" strokeWidth="0.4" className="text-foreground/30" />
                <line x1="38" y1="46" x2="42" y2="46" stroke="currentColor" strokeWidth="0.4" className="text-foreground/30" />
              </svg>
            </h2>
          ...
          >
            {faqs.map((faq, i) => (
              <div key={i} className="border-b border-border">
                ...
                >
                  <span className="text-sm md:text-base text-foreground/80 group-hover:text-foreground transition-colors pr-4">
                    {faq.question}
                  </span>
                ...
                >
                  <p className="text-sm text-foreground/40 leading-relaxed pb-5 pr-10">
                    {faq.answer}
                  </p>
                </div>
              </div>
